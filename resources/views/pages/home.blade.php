    ...
    <div class="container">
        <div class="row align-items-center hero-section">
            <div class="col-lg-6 hero-section-1">
                <div>
                    <h1 class="poppins-bold uppercase mb-4 text-center text-lg-left">
                        Sambutlah Masa Depan yang Cerah dengan Bergabung di TK Kemala Asri
                    </h1>
                    <p class=" text-center text-lg-left">Bermain Sambil Belajar, Membangun Masa Depan Ceria.</p>
        ...
        <div class="row flex-column-reverse flex-lg-row ">
            <div class="col-lg-6 ">
                <div class="w-full h-full overflow-hidden rounded" style="height: 504px;">
                    <img src="{{ asset('asset-kemala/image/358436412_807511021045532_1111811011840387803_n.jpg') }}" style="object-fit: cover; object-position: center;" alt="">
                </div>
            </div>
            <div class="col-lg-6 d-flex flex-column justify-content-center ps-lg-5 gap-3 mb-5 mb-lg-auto">
                ...
                <div class="d-flex justify-content-center justify-content-lg-start gap-4">
                    <a class="p-2 border-2 border border-2 rounded d-flex flex-column text-dark border-pink poppins-semibold text-decoration-none" href="#">
...
<section style="padding: 90px 0 90px 0;">
    <div class="container">
            ...
            <div class="col-lg-4 px-3 px-lg-5 mb-5">
                <a href="#" class="w-full text-dark text-decoration-none article-post">
                    <div class="rounded w-full overflow-hidden mb-3 position-relative">
                        <img class="d-block w-full" src="{{ asset('asset-kemala/image/358436412_807511021045532_1111811011840387803_n.jpg') }}" style="object-fit: cover; object-position: center; height: 250px" alt="">
                    ...
                    <h3 class="mb-4" style=" display: -webkit-box;
                            ...
                            overflow: hidden;">
                        Lorem ipsum dolor sit , amet consectetur adipisicing elit. Placeat aut dolorum distinctio, perspiciatis fugiat laborum
                    </h3>
                    <div class="d-flex justify-content-between">
                        <p class="uppercase text-secondary">23 Nov 24</p>
                        <p class="uppercase text-secondary">berita</p>
                    </div>
                </a>
            </div>
        ...
        <div class="text-center">
            <a href="#" class="btn btn-pink d-inline-block">Lihat Semua</a>
        </div>
    </div>
</section>
<section style="padding: 90px 0 90px 0;">
