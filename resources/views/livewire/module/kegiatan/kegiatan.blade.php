    ...
    <div class="row">
        <div class="col-xl">
            <div class="d-flex justify-content-between bd-highlight mb-4">
                <div>
                    <h2 style="text-transform: Capitalize">List {{$category}}</h2>
                </div>
                <div>
